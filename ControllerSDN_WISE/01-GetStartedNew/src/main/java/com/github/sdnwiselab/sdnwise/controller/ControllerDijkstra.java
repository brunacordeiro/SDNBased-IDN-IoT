        ...
        if (!source.equals(destination)) {
            ...
            if (sourceNode != null && destinationNode != null) {
                ...
                if (!lastSource.equals(source) || lastModification != networkGraph.getLastModification()) {
                    results.clear();
                    // calcular o caminho mais curto do sink para todos os nós
                ...
                if (path == null) {
                    path = new LinkedList<>();
                    for (Node node : dijkstra.getPathNodes(networkGraph.getNode(destination))) {  //construção da lista do caminho mais curto
