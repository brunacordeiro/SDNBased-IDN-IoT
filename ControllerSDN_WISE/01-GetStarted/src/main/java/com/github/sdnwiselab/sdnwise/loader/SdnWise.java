...
import com.github.sdn_idn_iot.idn.InteractionNetwork;
import com.github.sdn_idn_iot.idn.Mediador;
import com.github.sdn_idn_iot.idn.MessageHandler;
*/
...
public class SdnWise {
    ...
    VerificaQualidadeAr verQldAr    = new VerificaQualidadeAr();
    VerificaPeriodico   verPerd     = new VerificaPeriodico();
 //   ConsultarEvento     consltEvent = new ConsultarEvento();
...
/*                idMotes[5] = 6;
            ...
            behavior[0] = new Behavior(new BehaviorLogic(){
                @Override
                public void reify(InteractionNetwork interaction, Intent intent) {  //so vai ser executado quando o mediador.processIntents for chamado - classe anomymous 
                    ...
                    for (int mote = 1; mote < intent.getIdMotes().length; mote++){
                        interaction.polling("Qualidade do Ar", intent.getIdMotes()[mote], new MessageHandler() {
                            ...
                            public void message(String dado) {
                                ...
                                //verQldAr.verificarFatores(dado);                                
                            }
                        });
                    } // fim do for
                }
           ...
           // InteractionNetwork interaction = new InteractionNetwork(controller);
           // Mediador mediador = new Mediador(intentMap, interaction);
           // mediador.processIntents(intent);
            // start processIntents  
          while(true){
            //mediador.processIntents(intent);
            Thread.sleep(10000);
        } // fim do while
